...
class PlanEndpointTester:
    ...
    def test_create_plan(self):
        ...
        plan_data = {
            ...
            "description": f"Test plan description {datetime.now().timestamp()}",
            "price": 75.0,
            "duration_days": 30,
    ...
    def test_create_plan_duplicate_name(self):
        ...
        plan_data = {
            ...
            "description": "Duplicate plan description",
            "price": 50.0,
            "duration_days": 30,
            "gym_id": self.test_gym_id,
            "is_active": True
        ...
        try:
            ...
            # Now try to create second plan with same name
    ...
    def test_read_specific_plan_not_found(self):
        ...
        try:
            ...
            self.print_test_result("Read Specific Plan (Not Found)", success, "Should return 404")
    ...
    def test_update_plan(self):
        ...
        update_data = {
            "name": f"Updated Plan {datetime.now().timestamp()}",
            "description": f"Updated description {datetime.now().timestamp()}",
            "price": 100.0
        }
    ...
    def test_update_plan_not_found(self):
        ...
        try:
            ...
            success = response.status_code == 404
            self.print_test_result("Update Plan (Not Found)", success, "Should return 404")
    ...
    def test_delete_plan(self):
        ...
        try:
            ...
            success = response.status_code == 200
            self.print_test_result("Delete Plan", success, "Plan deleted successfully")
    ...
    def test_delete_plan_not_found(self):
        ...
        try:
            ...
            success = response.status_code == 404
            self.print_test_result("Delete Plan (Not Found)", success, "Should return 404")
    ...
    def test_create_plan_unauthorized(self):
        """Test creating a plan without admin access"""
        print("=== Testing Create Plan (Unauthorized) ===")
        
        if not self.trainer_token:
            self.print_test_result("Create Plan (Unauthorized)", False, "No trainer token")
            return False
        
        plan_data = {
            "name": f"Unauthorized Plan {datetime.now().timestamp()}",
            "description": "Unauthorized plan description",
            "price": 50.0,
            "duration_days": 30,
            "gym_id": self.test_gym_id,
            "is_active": True
        ...
        try:
            ...
            self.print_test_result("Create Plan (Unauthorized)", success, "Should return 403 Forbidden")
    ...
    def test_pagination(self):
        """Test pagination for plans list"""
        ...
        try:
            response = requests.get(f"{self.base_url}/plans/?skip=0&limit=2", headers={
                "Authorization": f"Bearer {self.admin_token}"
            })
            
            success = response.status_code == 200
            plans = response.json() if success else []
            self.print_test_result("Pagination", success, f"Found {len(plans)} plans (limit 2)")
